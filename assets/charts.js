(function () {
    ...
    if (data.holdings.length === 0) {
      ...
      data.holdings.forEach(function (h) {
        ...
        tr.innerHTML =
          ...
          '<td class="td-profit ' + dayProfitClass + '">' + signedMoney(h.todayProfit, true) + '</td>' +
  ...
  window.loadSampleData = function () {
    ...
    data.holdings = [
      ...
      { id: 2, category1: '股票', category2: '美股', name: '广发纳斯达克100ETF联接A', amount: 45230.18, shares: 19126.54, costPrice: 2.2110, startDate: '2026-02-03', todayProfit: 198.66, yesterdayProfit: 176.31, todayChange: 0.44, todayAction: '无' },
